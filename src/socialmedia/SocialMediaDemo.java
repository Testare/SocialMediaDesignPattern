...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        YouTubeVideoAdapter video1 = new YouTubeVideoAdapter(new YouTubeVideo("MormonMessages", "Bullying",
                "President Uchtdorf counsels us to stop bullying."));
        
        YouTubeVideoAdapter video2 = new YouTubeVideoAdapter(new YouTubeVideo("MormonMessages", "Patterns of Light",
                "Elder Bednar teaches about the Light of Christ."));
        
        YouTubeVideoAdapter video3 = new YouTubeVideoAdapter(new YouTubeVideo("Randy Pausch", "The Last Lecture",
